    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referenceName', models.CharField(blank=True, max_length=255, null=True)),
                ('referenceId', models.IntegerField(blank=True, null=True)),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('has_reset_password', models.BooleanField(default=False)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Prefer not to say', 'Prefer not to say')], default='Prefer not to say', max_length=50)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('address', models.CharField(blank=True, max_length=500, null=True)),
                ('phone_number', models.CharField(blank=True, max_length=255, null=True)),
                ('profile_picture', models.ImageField(default=None, null=True, upload_to=accounts.models.wrapper)),
